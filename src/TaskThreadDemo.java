public class TaskThreadDemo {
    public static void main(String[] args) {
        // Create tasks
        Runnable printA = new PrintChar("aaaaaaaaaa", 100000);
        Runnable printB = new PrintChar("bbbbbbbbbb" ,100000);
...
// Implementer runnable interface
// run() method
// Sæt den på en tråd (thread t  = new thread(objekt)
